$(document).ready(function () {
    ...
    ;(function (inner, second) {
        ...
        const sum = e => Math.ceil((e.pageX - second.offset().left) / size) * size
        // События
        inner
            .hover(function (e) {
                second.width(second.attr('offset') ? parseFloat(second.attr('offset')) : 0)
            })
    ...
    $(document).on('click', function (e) {
        if (!$(e.target).closest('.header-top__user, .header-top__user-drop').length) {
    ...
    $(document).on('click', function (e) {
        if (!$(e.target).closest('.card__header-link--points, .card__header-link--drop').length) {
    ...
    $(document).on('click', function (e) {
        if (!$(e.target).closest('.header-top__city-header, .header-top__city-drop').length) {
    ...
    $(document).on('click', function (e) {
        if (!$(e.target).closest('.header-bottom__balance-item, .header-bottom__balance-drop').length) {
    ...
    $(document).on('click', function (e) {
        if (!$(e.target).closest('.header-bottom__category-header, .header-bottom__category-drop').length) {
